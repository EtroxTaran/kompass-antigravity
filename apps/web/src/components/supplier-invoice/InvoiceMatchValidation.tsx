...
export function InvoiceMatchValidation({
  validation,
}: InvoiceMatchValidationProps) {
  const { poMatch, deliveryMatch, amountVariance, autoApproved, flags } =
    validation;
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="flex items-center justify-between p-3 border rounded-lg bg-card">
            <div className="flex items-center gap-3">
              <FileText
                className={`h-5 w-5 ${poMatch ? "text-green-500" : "text-red-500"}`}
              />
          ...
          <div className="flex items-center justify-between p-3 border rounded-lg bg-card">
            <div className="flex items-center gap-3">
              <Truck
                className={`h-5 w-5 ${deliveryMatch ? "text-green-500" : "text-red-500"}`}
              />
          ...
          <div className="flex items-center justify-between p-3 border rounded-lg bg-card">
            <div className="flex items-center gap-3">
              <AlertCircle
                className={`h-5 w-5 ${amountVariance <= 10 ? "text-green-500" : "text-yellow-500"}`}
              />
