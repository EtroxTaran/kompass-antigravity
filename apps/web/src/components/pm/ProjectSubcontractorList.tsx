                            ...
                            >
                                <div className="flex-1">
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <Badge variant={sub.status === "Completed" ? "default" : "outline"}>
                                            {sub.status}
                                        </Badge>
                                        {sub.budgetStatus === 'Warning' || sub.budgetStatus === 'Exceeded' ? (
                                            <Badge variant="destructive" className="flex items-center gap-1">
                                                <AlertTriangle className="h-3 w-3" /> Budget {sub.budgetStatus}
                                            </Badge>
                                        ) : null}
                                    </div>
