 ...
 */
export function ProjectMaterialCostWidget({
  projectId,
}: ProjectMaterialCostWidgetProps) {
        ...
        <CardTitle className="text-sm font-medium flex items-center justify-between">
          ...
          <span
            className={cn(
              ...
              getStatusColor(costs.percentUsed),
            )}
          >
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex items-center justify-between text-sm">
          ...
          <span
            className={cn(
              "font-medium",
              costs.variance >= 0 ? "text-green-600" : "text-red-600",
            )}
          >
            {costs.variance >= 0 ? "+" : ""}
        ...
        <div className="flex items-center justify-between text-xs text-muted-foreground">
          <span>
            {costs.deliveredCount} von {costs.itemCount} Positionen geliefert
          </span>
          <Link
