    ...
    const getMenuItems = (): MenuItem[] => {
        const allItems: MenuItem[] = [
            ...
            },
            {
                ...
                path: '/projects',
                submenu: [
                    { id: 'projektuebersicht', label: 'Projektübersicht', path: '/projects' },
                ],
            },
            {
                id: 'inventory',
                ...
                path: '/inventory',
                submenu: [
                    { id: 'material', label: 'Material', path: '/inventory/material' },
                    { id: 'supplier', label: 'Lieferanten', path: '/inventory/suppliers' },
                ],
            },
            {
                id: 'rechnungen',
                            ...
                            <li key={item.id}>
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        isActive && !hasSubmenu && 'bg-sidebar-primary text-sidebar-primary-foreground', // Highlight if leaf node matched
            ...
            <div className="border-t border-sidebar-border p-3 space-y-1">
                ...
                <button
                    ...
                    className={cn(
                        ...
                        location.pathname === '/settings' && "bg-sidebar-primary text-sidebar-primary-foreground hover:bg-sidebar-primary hover:text-sidebar-primary-foreground"
                    )}
                >
