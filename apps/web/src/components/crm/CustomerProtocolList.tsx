...
export function CustomerProtocolList({
  customerId,
}: CustomerProtocolListProps) {
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-muted-foreground text-center mb-4">
              Erstellen Sie ein Besuchsprotokoll, um Gesprächsnotizen und
                ...
                <TableBody>
                  {protocols.map((protocol) => (
                    <TableRow
                      ...
                      onClick={() =>
                        navigate(`/protocols/${protocol._id}/edit`)
                      }
                    >
