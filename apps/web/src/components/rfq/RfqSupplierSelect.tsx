...
export function RfqSupplierSelect({
    ...
    const filteredSuppliers = suppliers.filter((supplier) => {
        const matchesSearch = supplier.companyName.toLowerCase().includes(search.toLowerCase()) ||
    ...
    const isValid = selectedSuppliers.length >= minSelection && selectedSuppliers.length <= maxSelection;
