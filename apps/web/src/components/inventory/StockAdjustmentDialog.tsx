          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <div className="col-span-3">
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value={MovementType.INVENTORY_ADJUSTMENT}>
                    Manuelle Korrektur
                  </SelectItem>
                  <SelectItem value={MovementType.PURCHASE_RECEIPT}>
                    Wareneingang
                  </SelectItem>
                  <SelectItem value={MovementType.PROJECT_ALLOCATION}>
                    Ausgabe an Projekt
                  </SelectItem>
                  <SelectItem value={MovementType.WRITE_OFF}>
