...
export function PurchaseOrderDetail() {
    ...
    if (error || !order) return <div className="p-8 text-center text-red-500">Fehler beim Laden der Bestellung.</div>;
    ...
    return (
        <div className="space-y-6 max-w-5xl mx-auto pb-10">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-bold tracking-tight">Bestellung {order.orderNumber}</h1>
                            ...
                            <Dialog open={rejectDialogOpen} onOpenChange={setRejectDialogOpen}>
                                ...
                                <DialogContent>
                                    ...
                                    <DialogFooter>
                                        ...
                                        <Button variant="destructive" onClick={handleReject} disabled={!rejectionReason}>Ablehnen</Button>
                                    </DialogFooter>
                                </DialogContent>
                            </Dialog>
                        </>
                ...
                <div className="bg-red-50 border-l-4 border-red-400 p-4 rounded-r shadow-sm">
                    <div className="flex">
                        ...
                        <div className="ml-3">
                            ...
                            <div className="mt-2">
                                <Button variant="link" className="text-red-800 p-0 h-auto font-semibold" onClick={() => navigate(`/purchase-orders/${order._id}/edit`)}>
                            ...
                            <TableBody>
                                {order.items.map((item, index) => (
                                    <TableRow key={index}>
                                        ...
                                        <TableCell className="text-right">{formatCurrency(item.totalPrice, order.currency)}</TableCell>
                                    </TableRow>
                                ))}
                            </TableBody>
                        </Table>
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4 text-sm">
                            <div className="grid grid-cols-2 gap-2">
                                ...
                                <div>{order.expectedDeliveryDate ? formatDate(order.expectedDeliveryDate) : '-'}</div>

                                <div className="text-muted-foreground">Lieferant:</div>
                                <div className="font-medium">{supplier?.companyName || order.supplierId}</div>
                            </div>
                        </CardContent>
                    </Card>
                        ...
                        <Card>
                            ...
                            <CardContent className="text-sm space-y-2">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <span>{order.approvedAt && formatDate(order.approvedAt)}</span>
                                </div>
                            </CardContent>
                        </Card>
                    )}
