    ...
    return (
      <PortalLayout>
        <div className="text-center p-12">
          ...
          <Link to="/portal/projects" className="text-blue-600 hover:underline">
            Back to Overview
          </Link>
        </div>
      </PortalLayout>
  ...
  return (
    <PortalLayout>
      <div className="mb-6">
        <Link
          to="/portal/projects"
          className="text-slate-500 hover:text-slate-900 inline-flex items-center mb-4 text-sm"
        >
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-slate-600 mb-4">
                Contact your project manager for updates.
              </p>
