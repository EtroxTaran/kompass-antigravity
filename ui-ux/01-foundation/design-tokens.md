...
--sidebar-primary-foreground: oklch(1 0 0); /* Active text */
--sidebar-accent: oklch(0.8269 0.108 211.9627); /* Hover state */
...
```tsx
<Button className="bg-primary text-primary-foreground">Kunde anlegen</Button>
```
