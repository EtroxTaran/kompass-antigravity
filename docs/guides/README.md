...
**Purpose:** Step-by-step instructions and guides for users and developers

This directory contains comprehensive guides for getting started with KOMPASS development and usage.
...
**Purpose**: Clear statement of what this guide accomplishes
...
- ✅ **Screenshots/visuals** - Add visuals where helpful
- ✅ **Troubleshooting section** - Address common issues
- ✅ **Testing instructions** - How to verify the guide worked
...
4. Review with relevant team (dev/product/UX)
5. Test guide with fresh environment/user
6. Update cross-references and navigation
...
- **Getting Started**: Shared ownership (Engineering + Product)
